namespace TPShoes.Windows
{
    partial class FrmSizeCombo
    {
        ...
        private void InitializeComponent()
        {
            ...
            // SizecomboBox
            // 
            SizecomboBox.BackColor = SystemColors.InactiveCaption;
            SizecomboBox.DropDownStyle = ComboBoxStyle.DropDownList;
            SizecomboBox.Font = new Font("Candara", 11.25F);
            SizecomboBox.FormattingEnabled = true;
            SizecomboBox.Location = new Point(69, 18);
            SizecomboBox.Name = "SizecomboBox";
            SizecomboBox.Size = new Size(216, 26);
            SizecomboBox.TabIndex = 0;
